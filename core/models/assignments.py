...
class Assignment(db.Model):
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        assignment = Assignment.get_by_id(_id)
        assertions.assert_found(assignment, 'No assignment with this id was found')
        assertions.assert_valid(assignment.state in [AssignmentStateEnum.SUBMITTED, AssignmentStateEnum.GRADED], 'assignment not submitted cannot be graded')
        assertions.assert_valid((auth_principal.principal_id is not None) or (auth_principal.teacher_id == assignment.teacher_id), 'Assignment submitted to another teacher')
